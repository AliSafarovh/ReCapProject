...
namespace Core.Persistence.Dynamic
{
        ...
        private static readonly IDictionary<string, string> _operators = new Dictionary<string, string>
    {
        ...
        //        var sortParams = new List<Sort>
        //{
        //    new Sort("LastName", "asc")  // Soyadına görə artan
        //};

        //        // Filtr parametrləri
        //        var filterParams = new Filter("FirstName", "eq") { Value = "Ali" }; // "Ali" olanları seç

        //        // Dinamik sorğu yaradırıq
        //        var dynamicQuery = new DynamicQuery(sortParams, filterParams);

        //        // Məlumat bazasında sorğu
        //        var result = dbContext.Users.AsQueryable().ToDynamic(dynamicQuery);
